...
namespace NewRiverAttack.ObstaclesSystems.BossSystems.Behaviours
{
    public class MoveWestBehavior : Behavior
    {
        ...
        private const float MinimumWestDistance = 10f; // Distância mínima para considerar ao oeste
        ...
        public override async Task ExitAsync(CancellationToken token)
        {
            ...
            {
                var newBehavior = GetRandomNextBehavior(EnumDirectionBehavior.MoveWestBehavior, PlayerMaster.transform.position);
