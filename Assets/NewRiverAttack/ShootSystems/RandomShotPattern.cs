...
{
    [CreateAssetMenu(fileName = "RandomSpawnPattern", menuName = "ImmersiveGames/RiverAttack/ShootPatterns/RandomSpawn",
        order = 405)]
    public class RandomSpawnPattern : ShootPatternBase, IResettablePattern
    {
        ...
        public override void Execute(Transform spawnPoint, ObjectShoot shooter)
        {
            ...
            _spawnHelper ??= new RandomSpawnHelper(safeDistance, shooter.transform, Camera.main, safeEnemyDistance,
                myLayerMask);
