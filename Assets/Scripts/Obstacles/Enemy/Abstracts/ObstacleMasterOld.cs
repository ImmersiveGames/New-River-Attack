...
{
    public abstract class ObstacleMasterOld : ObjectMasterOLD
    {
        ...
        protected PlayerMasterOld PlayerMasterOld;
        ...
        internal static PlayerMasterOld WhoHit(Component other)
        {
            return other switch
            {
                Bullets bullet => bullet.ownerShoot as PlayerMasterOld,
                PlayerMasterOld player => player,
                _ => null
            };
        }
