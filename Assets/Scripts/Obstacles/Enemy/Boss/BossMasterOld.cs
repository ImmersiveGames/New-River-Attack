...
{
    public class BossMasterOld: ObstacleMasterOld
    {
        ...
        internal override void Awake()
        {
            ...
            GamePlayManager.instance.BossMasterOld = this;
        ...
        internal override void OnTriggerEnter(Collider other)
        {
            ...
            if (!other.GetComponent<Bullets>() || other.GetComponent<BulletBoss>() || !other.GetComponentInParent<PlayerMasterOld>()) return;
            ComponentToKill(other.GetComponent<PlayerMasterOld>(), CollisionType.Collider);
